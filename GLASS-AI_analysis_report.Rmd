...
unmapped_slide_tumor_count <- Tumor_Areas %>% filter(image_id %in% Slide_Areas_unmapped) %>% nrow()
...
```{r remove_unmapped_ihc_slides, eval = do_ihc_analysis, class.output="bg-success"}
...
```{r tumor_stained_cell_count, eval = do_ihc_analysis, s}
if (do_ihc_analysis) {
  cat("##### Stained cell counts {.tabset .tabset-fade .tabset-pills} \n\n")
}
```
